---
name: mintlify
description: This is a quote that stands out from the main content.
metadata:
  source: llms.txt
  source_url: https://www.mintlify.com/docs/llms-full.txt
  generated: 2026-02-26T08:46:27.710Z
---
...
- **https://mintlify.com/docs?assistant=open**
  - URL: https://mintlify.com/docs?assistant=open

- **https://mintlify.com/docs?assistant=explain webhooks**
  - URL: https://mintlify.com/docs?assistant=explain%20webhooks
...
- **Assistant**
  - URL: https://dashboard.mintlify.com/products/assistant
...
- **Swagger's OpenAPI Guide**
  - URL: https://swagger.io/docs/specification/v3_0/basic-structure/

- **The OpenAPI specification Markdown sources**
  - URL: https://github.com/OAI/OpenAPI-Specification/blob/main/versions/
...
- **Slack**
  - URL: https://slack.com/help/articles/218688467-Add-RSS-feeds-to-Slack

- **Email**
  - URL: https://zapier.com/apps/email/integrations/rss/1441/send-new-rss-feed-entries-via-email
...
- **Custom domain setup**
  - URL: https://dashboard.mintlify.com/settings/deployment/custom-domain
...
- **Audit log**
  - URL: https://dashboard.mintlify.com/settings/organization/audit-logs
...
- **Single Sign-On**
  - URL: https://dashboard.mintlify.com/settings/organization/sso
...
- **Delete DNS records**
  - URL: https://developers.cloudflare.com/dns/manage-dns-records/how-to/create-dns-records/#delete-dns-records
...
- **https://your-github-server.com**
  - URL: https://your-github-server.com
...
- **Git Settings**
  - URL: https://dashboard.mintlify.com/settings/deployment/git-settings

- **Git Settings**
  - URL: https://dashboard.mintlify.com/settings/deployment/git-settings

- **Install the GitHub App**
  - URL: #install-the-github-app
...
- **Add-ons**
  - URL: https://dashboard.mintlify.com/products/addons
...
- **mintlify-landing-page.vercel.app**
  - URL: https://mintlify-landing-page.vercel.app
...
- **Link**: Your domain name, which appears at the end of your dashboard URL. For example, if your dashboard URL is ` your domain name is `domain-name`
  - URL: https://dashboard.mintlify.com/org-name/domain-name`,

- **assistant API key**
  - URL: https://dashboard.mintlify.com/settings/organization/api-keys
...
- **Splunk Style Guide**
  - URL: https://docs.splunk.com/Documentation/StyleGuide/current/StyleGuide/Howtouse
...
- **automated code sample URL**
  - URL: https://www.speakeasy.com/docs/code-samples/automated-code-sample-urls
...
- **General**
  - URL: https://dashboard.mintlify.com/settings/deployment/general
