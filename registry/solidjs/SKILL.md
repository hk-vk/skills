---
name: solidjs
description: SolidJS Documentation documentation and resources. Use this skill when working with SolidJS Documentation or when the user mentions solidjs documentation.
metadata:
  source: llms.txt
  source_url: https://docs.solidjs.com/llms.txt
  generated: 2026-04-29T02:48:54.551Z
---
...
- **Overview**: Solid is a reactive JavaScript framework for building fast, efficient UIs. Learn about fine-grained reactivity and modern web development.
  - URL: /index.md
...
- **Stores**: Manage complex nested state efficiently with stores that provide fine-grained reactivity for objects and arrays in Solid.
  - URL: /concepts/stores.md

- **Refs**: Access and manipulate DOM elements directly using refs, forward refs between components, and create custom directives.
  - URL: /concepts/refs.md

### Advanced Concepts

- **Fine-grained reactivity**: Master Solid's fine-grained reactivity system for targeted UI updates, optimal performance, and efficient state management patterns.
  - URL: /advanced-concepts/fine-grained-reactivity.md

### Quick start

- **Quick start**: Start building with Solid quickly. Try the playground, create projects with templates, and get your first Solid app running in minutes.
  - URL: /quick-start.md
...
- **Environment variables**: Configure public and private environment variables in Solid apps using Vite's built-in support for secure configuration.
  - URL: /configuration/environment-variables.md
...
- **TypeScript**: Learn to configure TypeScript with SolidJS for enhanced type safety, better IDE support, and reliable component development.
  - URL: /configuration/typescript.md
